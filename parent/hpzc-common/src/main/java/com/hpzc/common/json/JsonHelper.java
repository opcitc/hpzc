...
public class JsonHelper {
	 ...
	 * @return 返回合并后的字符串
	 */
	// private static String encodeJson2PageJson(String jsonString, Integer
	// totalCount) {
	...
	// */
	// public static final String encodeList2PageJson(List<?> list, Long
	// totalCount, String dataFormat) {
	//
	...
	// * @return
	// */
	// public static String encodeMap2FormLoadJson(Map<?,?> map, String
	// pFormatString) {
	//
	// String jsonString = "";
	...
	// }
	// jsonString = "{success:"
	// + (StringUtils.isEmpty((String) map.get("success")) ? "true" :
	// map.get("success")) + ",data:"
	// + sunJsonString + "}";
	// if (log.isInfoEnabled()) {
	// log.info("序列化后的JSON资料输出:\n" + jsonString);
	// }
	...
	// * @return dto
	// */
	// public static Map<String, Object> convertJson2MapObject(String
	// jsonString) {
	//
	...
	// for (Iterator<Entry<String, JsonElement>> iter = entrySet.iterator();
	// iter.hasNext(); ){
